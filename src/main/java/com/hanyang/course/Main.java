...
import com.hanyang.course.model.NotFoundException;
...
public class Main {
    ...
    private static String getFlashMessage(Request req) {
        ...
        return req.session().attribute(FLASH_MESSAGE_KEY) == null ?
                null : (String)req.session().attribute(FLASH_MESSAGE_KEY);
    }
